...
function GridDropZone(_a) {
    var id = _a.id, children = _a.children, style = _a.style, _b = _a.disableDrag, disableDrag = _b === void 0 ? false : _b, _c = _a.disableDrop, disableDrop = _c === void 0 ? false : _c, columnWidth = _a.columnWidth, rowHeight = _a.rowHeight, other = tslib.__rest(_a, ["id", "children", "style", "disableDrag", "disableDrop", "columnWidth", "rowHeight"]);
...
function GridItem(_a) {
    var children = _a.children, style = _a.style, className = _a.className, disableDragItem = _a.disableDrag, other = tslib.__rest(_a, ["children", "style", "className", "disableDrag"]);
    ...
    var top = context.top, disableDragGlobal = context.disableDrag, endTraverse = context.endTraverse, onStart = context.onStart, mountWithTraverseTarget = context.mountWithTraverseTarget, left = context.left, i = context.i, onMove = context.onMove, onEnd = context.onEnd, grid = context.grid, isDragging = context.dragging;
    var disableDrag = disableDragGlobal || disableDragItem;
